      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-base md:text-lg text-gray-300 mt-4 max-w-2xl mx-auto px-4">
            Live production applications showcasing full-stack development, AI/ML integration, and modern web technologies
          </p>
        </motion.div>
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
                ...
                <div className="lg:w-2/5 bg-gradient-to-br from-purple-600 to-pink-600 p-8 md:p-12 flex items-center justify-center relative overflow-hidden min-h-[300px]">
                  <div className="absolute inset-0 opacity-10">
                  ...
                  <div className="text-center z-10">
                    ...
                    <h3 className="text-xl md:text-2xl font-bold text-white mb-4 px-4">{project.title}</h3>
                    <a
                ...
                <div className="lg:w-3/5 p-6 md:p-8">
                  <div className="mb-4">
                    <span className="inline-block px-4 py-1 bg-purple-500/20 border border-purple-400/30 text-purple-400 rounded-full text-xs md:text-sm font-semibold mb-4">
                      Project {index + 1}
                    </span>
        ...
        >
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-xl p-6 shadow-xl text-center border border-purple-500/20">
            ...
            <div className="text-gray-300 font-semibold text-sm md:text-base">Live Projects</div>
          </div>
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-xl p-6 shadow-xl text-center border border-pink-500/20">
            <div className="text-3xl md:text-4xl font-bold text-pink-400 mb-2">10+</div>
            <div className="text-gray-300 font-semibold text-sm md:text-base">Technologies Used</div>
          </div>
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-xl p-6 shadow-xl text-center border border-blue-500/20">
            ...
            <div className="text-gray-300 font-semibold text-sm md:text-base">Deployed & Running</div>
          </div>
        </motion.div>
      </div>
    </section>
